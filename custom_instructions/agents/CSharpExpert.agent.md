# MODIFY THIS TO MATCH YOU PROJECT
...
- Plan and write tests (TDD/BDD) with xUnit, NUnit, or MSTest // TODO: Change to relevent framework
...
- App type: web / desktop / console / lib. // TODO: Change to relevant
- Packages (and multi-targeting).
- Nullable on? (`<Nullable>enable</Nullable>` / `#nullable enable`) // TODO: Change to relevent
